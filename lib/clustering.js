...

{
  ...
  "strategicPoints": [
    {
      "name": "Facility / city / chokepoint name",
...
Rules for strategicPoints :
- Only include locations that are explicitly or strongly implied in events
  (refineries, oil terminals, nuclear sites, key cities, military bases, straits, ports...)
- Map each point to the correct countryName
- type is a short classifier: "oil_infrastructure", "nuclear_site", "military_base", "city",
  "chokepoint" (e.g. Strait of Hormuz, Bab el-Mandeb, Suez), or "other"
- importance is a float 0.1–1.0 based on how central this point is to escalation risk
- eventIds lists all events that mention or clearly relate to this point
